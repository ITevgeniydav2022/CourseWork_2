import exсeption.IncorrectTaskParameterException;
import exсeption.TaskNotFoundException;
import model.*;
...
public class Main {
    ...
    private static void printTasksByDay(Scanner scanner) {
        do {
            System.out.print("Введите дату задачи в формате \""
                    + LocalDate.now().format(Constant.DATE_FORMATTER) + "\": ");
    ...
    private static LocalDateTime inputDateTime(Scanner scanner) {
        ...
        do {
            System.out.print("Введите дату и время задачи в формате \""
